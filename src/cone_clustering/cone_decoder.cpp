...
class Lidar_Decoder{
    ...
    void callback(const sensor_msgs::PointCloud2& msg){
	    ...
	    p.point_2d.x = point.x;
            ...
            if(p.point_2d.x > 0 && point.intensity > 10 && sqrt(p.point_2d.x*p.point_2d.x+p.point_2d.y*p.point_2d.y) < distance_tolerance && p.channel <= 9){
